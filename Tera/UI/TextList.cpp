...
#pragma region 소모품상점
	CreateUICTextData
	(
		{ "소모품상점", "정산하기", "하급회복물약", "중급회복물약", "상급회복물약", "하급마나물약", "중급마나물약", "상급마나물약", "미스테리부적", "마을귀환서" }
		, { { 200,10,0 },{ 310, 256, 0 },{ 65, 93, 0 },{ 240, 93, 0 },{ 65, 132, 0 },{ 241, 129, 0 },{ 65,172,0 },{ 241,172,0 },{ 65, 210, 0 },{ 240, 210, 0 } }
		, { { 25, 15 },{ 15, 5 },{ 20, 10 },{ 20, 10 },{ 20, 10 },{ 20, 10 },{ 20, 10 },{ 20, 10 },{ 20, 10 },{ 20, 10 } }
