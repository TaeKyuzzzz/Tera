...
#pragma region copyItem
	...
	CreateItem("중급회복물약", "Texture/ItemIcon/HPMid.png", NOTANITEM, 100, 100, m_vItemImitation, "ItemExplaneWindow");
	CreateItem("상급회복물약", "Texture/ItemIcon/HPBig.png", NOTANITEM, 150, 200, m_vItemImitation, "ItemExplaneWindow");
	CreateItem("하급마나물약", "Texture/ItemIcon/MPSmall.png", NOTANITEM, 50, 60, m_vItemImitation, "ItemExplaneWindow");
	CreateItem("중급마나물약", "Texture/ItemIcon/MPMid.png", NOTANITEM, 100, 120, m_vItemImitation, "ItemExplaneWindow");
	CreateItem("상급마나물약", "Texture/ItemIcon/MPBig.png", NOTANITEM, 150, 240, m_vItemImitation, "ItemExplaneWindow");
	CreateItem("미스테리부적", "Texture/ItemIcon/MysteryPaper.png", NOTANITEM, 0, 200, m_vItemImitation, "ItemExplaneWindow");
	CreateItem("마을귀환서", "Texture/ItemIcon/CityRecall.png", NOTANITEM, 0, 400, m_vItemImitation, "ItemExplaneWindow");


	CreateItem("대검", "Texture/ItemIcon/Claymore.png", NOTANITEM, 15, 200, m_vItemImitation, "ItemExplaneWindow");
	CreateItem("아이스소드", "Texture/ItemIcon/TwohandIce.png", NOTANITEM, 150, 4000, m_vItemImitation, "ItemExplaneWindow");
	CreateItem("스카이소드", "Texture/ItemIcon/TwohandSky.png", NOTANITEM, 100, 3000, m_vItemImitation, "ItemExplaneWindow");
	CreateItem("고등어", "Texture/ItemIcon/TwohandFish.png", NOTANITEM, 50, 2000, m_vItemImitation, "ItemExplaneWindow");
	//
	//블랙셋트
	CreateItem("검은마력의옷", "Texture/ItemIcon/BlackClothes.png", NOTANITEM, 75, 3600, m_vItemImitation, "ItemExplaneWindow");
	CreateItem("검은마력의신발", "Texture/ItemIcon/BlackShoes.png", NOTANITEM, 25, 1400, m_vItemImitation, "ItemExplaneWindow");
	CreateItem("검은마력의장갑", "Texture/ItemIcon/BlackGlove.png", NOTANITEM, 20, 1100, m_vItemImitation, "ItemExplaneWindow");

	//레더셋트
	CreateItem("레더아머", "Texture/ItemIcon/LeatherClothes.png", NOTANITEM, 50, 2600, m_vItemImitation, "ItemExplaneWindow");
	CreateItem("레더슈즈", "Texture/ItemIcon/LeatherShoes.png", NOTANITEM, 15, 1100, m_vItemImitation, "ItemExplaneWindow");
	CreateItem("레더글러브", "Texture/ItemIcon/LeatherGlove.png", NOTANITEM, 11, 900, m_vItemImitation, "ItemExplaneWindow");

	//퍼플플랫셋트
	CreateItem("퍼플플랫아머", "Texture/ItemIcon/PurpleClothes.png", NOTANITEM, 20, 1000, m_vItemImitation, "ItemExplaneWindow");
	CreateItem("퍼플플랫슈즈", "Texture/ItemIcon/PurpleShoes.png", NOTANITEM, 5, 200, m_vItemImitation, "ItemExplaneWindow");
	CreateItem("퍼플플랫글러브", "Texture/ItemIcon/PurpleGlove.png", NOTANITEM, 3, 160, m_vItemImitation, "ItemExplaneWindow");
#pragma endregion
